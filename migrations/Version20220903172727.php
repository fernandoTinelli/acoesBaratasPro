 ...
 */
final class Version20220903172727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tipo_transacao (id INT AUTO_INCREMENT NOT NULL, nome VARCHAR(6) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transacao (id INT AUTO_INCREMENT NOT NULL, tipo_id INT NOT NULL, usuario_id INT DEFAULT NULL, data DATETIME NOT NULL, valor NUMERIC(10, 2) NOT NULL, INDEX IDX_6C9E60CEA9276E6C (tipo_id), INDEX IDX_6C9E60CEDB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
